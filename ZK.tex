...
Do you need some help with the document on primes in certain arithmetic progressions?

Sorry for the delayed response. I have been a bit tied up for the last few weeks. As I mentioned before, I started part-time work (20 hours a week) as a cryptosystems auditor for a Berlin-based company. 

I also found part-time work as a cryptographer at another company (based in California, but it is all remote and they do not expect me to move). This place actually wants me to start full-time but it seems quite shady and is embroiled in civil lawsuits and allegations of fraud. So I am planning to try to stay on as a consultant until I find a full-time job at a more respectable place. As a consultant/contractor, I am able to stay at an arm's length. 
