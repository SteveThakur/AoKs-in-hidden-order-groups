...
A headhunter who approached me recently submitted an application on my behalf for a position with you guys. I actually told him to wait until I asked you if you were hiring at all at the moment but he seems to have already submitted it since I got an automated email last week.

To be honest, I am not much stronger as a candidate than I was when we informally discussed this six months ago. I certainly have been improving my coding skills, but I have mostly been using Python and it seems you guys use Rust, which I haven't used before.

Axoni had a sudden mass layoff a few months ago (because of the recession) and as the one person doing R&D and focusing on long-term projects, I was probably one of the first on the chopping block. So I have been looking for work.

Do you have any general advice about what skills I can acquire to be more employable within the cryptography-adjacent space? I have been looking at other types of jobs, too, since the cryptography space is not that big and the job market for R&D is never good during recessions. But obviously, it would be nice if I can somehow stay in this field. 

On an unrelated note, I forgot to specifically ask this before. The PoGCD protocol (in the incomplete preprint I sent you) basically allows a Prover to demonstrate that the intersection of two sets (or multisets) is a third set. This proof can be publicly verified against the commitments to the three sets. Do you happen to see any potential real-world applications for this? 

As I mentioned earlier, I started thinking about this because my last employer was interested in sharded blockchains (in addition to addressing state bloat). Hence, the arguments for disjointness in multiple accumulators. But it would be nice to find some concrete applications elsewhere too.
